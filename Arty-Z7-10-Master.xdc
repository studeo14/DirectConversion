...
set_property MARK_DEBUG false [get_nets {ad_IBUF[6]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[7]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[3]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[0]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[2]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[5]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[4]}]
set_property MARK_DEBUG false [get_nets {ad_IBUF[1]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[0]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[1]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[3]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[2]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[4]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[5]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[6]}]
set_property MARK_DEBUG false [get_nets {da_OBUF[7]}]
