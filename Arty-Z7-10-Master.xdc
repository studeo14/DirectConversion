...
## Pmod Header JA
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {ad[0]}]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {ad[1]}]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {ad[2]}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {ad[3]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {ad[4]}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {ad[5]}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {ad[6]}]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {ad[7]}]


# Pmod Header JB
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {da[0]}]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {da[1]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {da[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {da[3]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {da[4]}]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {da[5]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {da[6]}]
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {da[7]}]
...
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports daclk]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports adclk]
...
set_property MARK_DEBUG true [get_nets {ad_IBUF[3]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[0]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[1]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[2]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[4]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[5]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[6]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[3]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[2]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[1]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[0]}]
set_property MARK_DEBUG true [get_nets {ad_IBUF[7]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[7]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[6]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[5]}]
set_property MARK_DEBUG true [get_nets {da_OBUF[4]}]
...
connect_debug_port u_ila_0/clk [get_nets [list daclk_OBUF]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 8 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {da_OBUF[0]} {da_OBUF[1]} {da_OBUF[2]} {da_OBUF[3]} {da_OBUF[4]} {da_OBUF[5]} {da_OBUF[6]} {da_OBUF[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {ad_IBUF[0]} {ad_IBUF[1]} {ad_IBUF[2]} {ad_IBUF[3]} {ad_IBUF[4]} {ad_IBUF[5]} {ad_IBUF[6]} {ad_IBUF[7]}]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets daclk_OBUF]
